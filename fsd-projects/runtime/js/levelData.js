    ...
    var levelData = [
      ...
      },
      {
        ...
        gameItems: [
          ...
          { type: "enemy", x: 735, y: groundY - 50, offsetX: -86, offsetY: -100, velocity: -3, image: "img/demon.png", imageSizeX: 0.37, imageSizeY: 0.37, integrityAmount1: -10, integrityAmount2: 10},
          { type: "enemy", x: 1350, y: groundY - 50, offsetX: -86, offsetY: -100, velocity: -3, image: "img/demon.png", imageSizeX: 0.37, imageSizeY: 0.37, integrityAmount1: -10, integrityAmount2: 10},
          { type: "enemy", x: 1750, y: groundY - 50, offsetX: -86, offsetY: -100, velocity: -3, image: "img/demon.png", imageSizeX: 0.37, imageSizeY: 0.37, integrityAmount1: -10, integrityAmount2: 10},
          { type: "reward", x: 900, y: groundY - 90, offsetX: -50, offsetY: -50, velocity: -3, image: "img/Money_Bag.png", imageSizeX: 0.10, imageSizeY: 0.10, integrityAmount: +10},
          { type: "reward", x: 1500, y: groundY - 90, offsetX: -50, offsetY: -50, velocity: -3, image: "img/Money_Bag.png", imageSizeX: 0.10, imageSizeY: 0.10, integrityAmount: +10},
          { type: "reward", x: 1900, y: groundY - 90, offsetX: -50, offsetY: -50, velocity: -3, image: "img/Money_Bag.png", imageSizeX: 0.10, imageSizeY: 0.10, integrityAmount: +10},
